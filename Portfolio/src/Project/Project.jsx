...
const ProjectsPage = () => (
  <section className="2xl:container mx-auto my-2 px-2">
    <div className="w-[95%] mx-auto bg-gray-900/95 dark:bg-gray-800 rounded-2xl shadow p-6 space-y-8">
      <div className="text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-pink-400 mb-2">My Projects</h2>
